"""
Base settings for Medicine ERP project.
"""
import os
...
# ASGI_APPLICATION = 'config.asgi.application'  # Only for channels service

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.environ.get('POSTGRES_DB', 'medicine_erp'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Medicine ERP API',
    'DESCRIPTION': 'ERP/МИС система для стоматологий',
    'VERSION': '1.0.0',
